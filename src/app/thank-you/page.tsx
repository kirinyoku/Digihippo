...
import { Product, ProductFile, User } from "@/config/payload-types";
...
export default async function Page({ searchParams }: PageProps) {
  ...
  return (
    <main className="relative lg:min-h-full">
      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-16 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
                      ...
                      <div className="relative h-24 w-24">
                        {typeof image !== "string" && image.url ? (
                          <Image
                            ...
                            className="flex-none rounded-md bg-gray-600 object-cover object-center"
                          />
                        ) : null}
                      </div>
